...
if __name__ == '__main__':
    ...
    model = KoBARTConditionalGeneration.load_from_checkpoint('logs/kobart_chitchat-model_chp/total_train_v2.ckpt', hparams=hparams)
    ...
    def send():
        ...
        if msg != '':
            ...
            res = model.chat(msg)
            res1 = model.chat(res)
            #res1 = model.chat에 res 넣으면 모델1에 반응
            #그렇지않고 msg 넣으면 둘 다 사람에게 반응
            ...
            ChatLog.window_create(END, window=Label(ChatLog, fg="#000000", text=res1, 
